  ...
  return (
    ...
    >
      <div className="grid sm:grid-cols-[140px_minmax(0,1fr)] sm:items-stretch">
        <div className="flex min-w-0 flex-col items-center justify-center border-b border-gray-200 bg-gray-50 px-4 py-4 text-center sm:border-b-0 sm:border-r">
        ...
        <div className="grid min-w-0 grid-rows-[repeat(2,minmax(0,1fr))] bg-white">
          <div className="grid min-w-0 grid-cols-[72px_minmax(0,1fr)] border-b border-gray-200">
            <p className="flex items-center justify-center bg-gray-50 px-3 py-2 text-center text-xs font-semibold text-gray-600">
              주소지
            </p>
            <p className="flex min-w-0 items-center whitespace-pre-wrap break-words [overflow-wrap:anywhere] border-l border-gray-200 px-3 py-2 text-left text-sm leading-5 text-gray-800">
              {address?.trim() || "등록 없음"}
            </p>
          </div>
